...
class SheetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sheet" do
    assert_difference('Sheet.count') do
      post sheets_url, params: { sheet: { consinee: @sheet.consinee, enddate: @sheet.enddate, issuedate: @sheet.issuedate, title: @sheet.title } }
    end
  ...
  test "should update sheet" do
    patch sheet_url(@sheet), params: { sheet: { consinee: @sheet.consinee, enddate: @sheet.enddate, issuedate: @sheet.issuedate, title: @sheet.title } }
